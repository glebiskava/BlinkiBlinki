...
public class TestEncodeDecode {
    ...
    @ParameterizedTest (name = "Critical: Test Encode For RGBRequest R-{0} G-{1} B-{2}")
    ...
    @ParameterizedTest(name = "Critical: On request decode with led-{2} time-{3}")
        ...
        switch (type) {
            ...
            case "RGB":
                try {
                    ...
                    Assertions.assertEquals(rgbRequest, expected);
                } catch (DecodingException e) {
                    throw new AssertionError(e.getMessage());
                }
                break;
    ...
    @ParameterizedTest (name = "Critical: Test Encode For OnRequest Led-{0} Time-{1}")
    ...
    @ParameterizedTest (name = "Critical: Test Decode For RGBRequest R-{1} G-{2} B-{3}")
    ...
    @ParameterizedTest (name = "Critical: Test Decode For OnRequest Led-{1} Time-{2}")
