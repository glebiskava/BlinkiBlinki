...
public class TestOnRequest {
    ...
    public void ErrorTest_Encode_ON_Request(int led, int time) {
        assertThrows(DecodingException.class, () -> new OnRequest(led, time));
    }
    ...
    public void Test_Encode_Error_Message_ON_Request(int led, int time) {
        DecodingException exception = assertThrows(DecodingException.class, () -> new OnRequest(led, time));
        assertEquals("Led Nr. muss zwischen 0 und 2 sein und die Zeit zwischen 0 und 29!", exception.getMessage());
    }
    ...
    static Stream<Arguments> onRequestDecodeValues() {
        ...
        public void ErrorTest_Decode_On_Request(String encoded) {
            assertThrows(DecodingException.class, () -> new OnRequest(encoded));
        }
        ...
        public void Test_Decode_Error_Message_On_Request(String encoded) {
            DecodingException exception = assertThrows(DecodingException.class, () -> new OnRequest(encoded));
            assertEquals("Invalid encoding format for OnRequest", exception.getMessage());
        }
