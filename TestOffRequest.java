...
public class TestOffRequest {
    ...
    public void ErrorTest_Encode_Off_Request(int led) {
        assertThrows(IllegalArgumentException.class, () -> new OffRequest(led));
    }
    ...
    public void Test_Encode_Error_Message_OFF_Request(int led) {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> new OffRequest(led));
